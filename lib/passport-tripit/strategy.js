...
import OAuthStrategy, { InternalOAuthError } from 'passport-oauth1';
...
export class Strategy extends OAuthStrategy {
  constructor(options, verify) {
    options ??= {};
    options.requestTokenURL ??= 'https://api.tripit.com/oauth/request_token';
    options.accessTokenURL ??= 'https://api.tripit.com/oauth/access_token';
    ...
    options.sessionKey ??= 'oauth:tripit';
   ...
   * @api protected
   */
  userProfile(token, tokenSecret, _params, done) {
